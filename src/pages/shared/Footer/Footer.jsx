...
const Footer = () => {
  return (
      ...
      <div>
        <p className="font-bold text-lg lg:text-3xl lg:ml-11">
          Crazy <span className="text-red-500">Car</span>
        </p>
        <img src={footer} alt="" className="w-1/2" />
        <small className="ms-4 bg-neutral text-neutral-content text-center">Copyright © 2023 - All right reserved</small>
      </div>
      ...
      <div>
        <span className="footer-title">
          <SiAdguard className="w-8 h-8 text-rose-600" />
        </span>
