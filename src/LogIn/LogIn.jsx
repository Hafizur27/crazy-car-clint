...
const LogIn = () => {
  ...
  <div className="hero-content flex-col lg:flex-row-reverse ">
    ...
    <Lottie animationData={login} loop={true} className='w-1/2 mx-auto'/>
    </div>
    <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
      <div className="card-body">
       ...
       <button className="btn btn-outline btn-primary w-1/4"><FaGoogle/>  </button>
      <div>
      <small className='text-sm'>
          If you did not have an account ? please
          <Link to="/register" className="underline decoration-cyan-500 text-cyan-500 ml-1 font-medium">
         Register
          </Link>
        </small>
      </div>
